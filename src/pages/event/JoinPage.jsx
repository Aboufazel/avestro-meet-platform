      ...
      <div className="w-full max-w-md flex flex-col gap-4">
        ...
        <div className="bg-olive-900 border border-olive-700 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            <span className={`w-2 h-2 rounded-full ${status.dot} ${room.status === 'live' ? 'animate-pulse' : ''}`} />
        ...
        {room.status === 'ended' ? (
          ...
          <div className="bg-olive-900 border border-olive-700 rounded-2xl p-6 flex flex-col gap-3">
            ...
            {token ? (
              <>
                <div className="flex items-center gap-3 p-3 bg-olive-950 rounded-xl border border-olive-700">
